...
public class ChessXiang extends Chessman implements ChessRule {
    ...
    public boolean checkRule(Point currentP, Point nextP, ChessBoard cBoard) {
        ...
        if (ChessColor.RED.equals(color)) {
            // (0,5) (2,9) (2,5) (4,7) (6,9) (6,5) (8,7)
            if (nextP.getX() == 0 && nextP.getY() == 5) res = true;
            if (nextP.getX() == 2 && (nextP.getY() == 9 || nextP.getY() == 5)) res = true;
            if (nextP.getX() == 4 && nextP.getY() == 7) res = true;
            if (nextP.getX() == 6 && (nextP.getY() == 9 || nextP.getY() == 5)) res = true;
            if (nextP.getX() == 8 && nextP.getY() == 7) res = true;
        }
        if (ChessColor.BLACK.equals(color)) {
            // (0,2) (2,0) (2,4) (4,2) (6,0) (6,4) (8,2)
            if (nextP.getX() == 0 && nextP.getY() == 2) res = true;
            if (nextP.getX() == 2 && (nextP.getY() == 0 || nextP.getY() == 4)) res = true;
            if (nextP.getX() == 4 && nextP.getY() == 2) res = true;
            if (nextP.getX() == 6 && (nextP.getY() == 0 || nextP.getY() == 4)) res = true;
            if (nextP.getX() == 8 && nextP.getY() == 2) res = true;
        }
